...
const TransactionPage = () => {
	const {id}=useParams();
	// console.log('id',id)
	const {data,loading:queryLoading}=useQuery(GET_TRANSACTION,{
		variables:{
			id:id
		}
	})
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			console.log("Error occured in updating transaction",error)
		}
	};
	...
	return (
		data?.transaction && <div className='h-screen max-w-4xl mx-auto flex flex-col items-center'>
			{console.log('formData',formData)}
